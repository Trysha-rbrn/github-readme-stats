...
const statCardLocales = ({ name, apostrophe }) => {
  ...
  return {
    "statcard.title": {
      ...
      sr: `Профил корисника ${encodedName}`,
    },
    "statcard.ranktitle": {
      ar: `${encodedName} إحصائيات غيت هاب`,
      cn: `${encodedName} 的 GitHub 统计数据`,
      ...
      vi: `Thống Kê GitHub ${encodedName}`,
      se: `GitHubstatistik för ${encodedName}`,
      sr: `Статистика корисника ${encodedName}`,
    },
    "statcard.totalstars": {
      ar: "مجموع النجوم",
      cn: "获标星数（star）",
    ...
    "statcard.prs-merged": {
      ...
      sr: "Укупан број обједињених PRова",
    },
...
const wakatimeCardLocales = {
  ...
  "wakatimecard.notpublic": {
    ...
    sr: "Профил WakaTime корисника није јаван",
  },
